...
const (
	...
	ProtoLDAP          = "ldap"
	ProtoLDAPS         = "ldaps"
	ProtoMinecraftJava = "minecraft-java"
	ProtoModbus        = "modbus"
	ProtoMQTT          = "mqtt"
	ProtoMSSQL         = "mssql"
	ProtoMySQL         = "mysql"
...
func (e Service) Metadata() Metadata {
	...
	case ProtoPOP3S:
		...
		_ = json.Unmarshal(e.Raw, &p)
		return p
	case ProtoMinecraftJava:
		var p ServiceMinecraftJava
		_ = json.Unmarshal(e.Raw, &p)
		return p
	default:
...
type ServiceMinecraftJava struct {
...
func (e ServiceMinecraftJava) Type() string { return ProtoMinecraftJava }
